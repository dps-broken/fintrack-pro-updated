...
const scheduleDailyReport = () => {
  ...
  cron.schedule('51 0 * * *', asyncHandler(async () => {
 ...
 // Define the start and end of "yesterday" in TARGET_TIMEZONE and convert to UTC for DB
const startDate = yesterdayMoment.clone().startOf('day').utc().toDate(); // 00:00:00 IST converted to UTC
const endDate = yesterdayMoment.clone().endOf('day').utc().toDate();     // 23:59:59.999 IST converted to UTC
    // 23:59:59.999 of yesterday in TARGET_TIMEZONE, converted to UTC Date
