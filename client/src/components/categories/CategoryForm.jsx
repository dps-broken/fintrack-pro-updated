...
const CategoryForm = ({
  ...
  const validationSchema = Yup.object({
    name: Yup.string()
      ...
      .test(
        'is-unique',
        'A custom category with this name and type already exists.',
        function (value) {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className='space-y-4 md:space-y-6'>
      ...
      />
      <p className='text-xs text-text-muted-light dark:text-text-muted-dark -mt-3'>
        Refer to an icon library like Font Awesome (e.g., "FaCar"). Future update could include a
        visual picker.
      </p>
      ...
      <div className='flex items-end space-x-3'>
        ...
        <div
          ...
          style={{
            backgroundColor:
              formik.values.color && formik.getFieldMeta('color').error === undefined
                ? formik.values.color
                : 'transparent',
          }}
          title='Color Preview'
