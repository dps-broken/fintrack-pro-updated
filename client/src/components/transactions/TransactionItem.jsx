    ...
    >
      <div className='flex items-center space-x-4 flex-1 min-w-0'>
        ...
        <div className='min-w-0 flex-1'>
          <p
            className='text-sm font-medium text-text-light dark:text-text-dark truncate'
            title={sourceDestination}
          >
            {sourceDestination}
          </p>
          ...
          {notes && (
            <p
              className='text-xs text-text-muted-light dark:text-text-muted-dark mt-1 truncate'
              title={notes}
            >
              {notes}
            </p>
      ...
      <div className='flex items-center space-x-2 sm:space-x-3 ml-4 flex-shrink-0'>
        <p
          className={`text-sm sm:text-base font-semibold ${isExpense ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}`}
        >
