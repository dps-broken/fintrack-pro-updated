    ...
    datasets: [
      {
        ...
        data: [totalIncome],
        backgroundColor:
          actualTheme === 'dark' ? 'rgba(74, 222, 128, 0.7)' : 'rgba(34, 197, 94, 0.7)', // Green
      ...
      },
      {
        ...
        data: [totalExpense],
        backgroundColor:
          actualTheme === 'dark' ? 'rgba(248, 113, 113, 0.7)' : 'rgba(239, 68, 68, 0.7)', // Red
      ...
      },
      {
        ...
        backgroundColor:
          actualTheme === 'dark' ? 'rgba(56, 189, 248, 0.7)' : 'rgba(52, 152, 219, 0.7)', // Blue
      ...
      {totalIncome > 0 || totalExpense > 0 ? (
        ...
        <div className='flex items-center justify-center h-full'>
          <p className='text-text-muted-light dark:text-text-muted-dark'>
            Not enough data for savings ratio chart.
          </p>
        </div>
      )}
    </motion.div>
